...
public class ObjectFactory<T> {
    ...
    public T newInstance(Object... args) throws SecurityException, NoSuchMethodException, IllegalArgumentException,
    ...
    public T newInstance(Class<?>[] argsClasses, Object[] constructorArgs) throws SecurityException,
    ...
    public T newInstanceAndBindProperties(Map<String, Object> propertys) throws InstantiationException,
                                                                        IllegalAccessException {
        T obj = this.claxx.newInstance();
    ...
    public T newInstanceAndBindProperties(Class<?>[] argsClasses, Object[] constructorArgs,
                                          Map<String, Object> propertys) throws SecurityException,
                                                                        NoSuchMethodException,
                                                                        IllegalArgumentException,
