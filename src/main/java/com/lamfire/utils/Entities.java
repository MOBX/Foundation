...
class Entities {
    ...
    private static final String[][] BASIC_ARRAY     = { { "quot", "34" }, { "amp", "38" }, { "lt", "60" },
            { "gt", "62" }                         };

    private static final String[][] APOS_ARRAY      = { { "apos", "39" } };

    static final String[][]         ISO8859_1_ARRAY = { { "nbsp", "160" }, { "iexcl", "161" }, { "cent", "162" },
            { "pound", "163" }, { "curren", "164" }, { "yen", "165" }, { "brvbar", "166" }, { "sect", "167" },
            { "uml", "168" }, { "copy", "169" }, { "ordf", "170" }, { "laquo", "171" }, { "not", "172" },
            { "shy", "173" }, { "reg", "174" }, { "macr", "175" }, { "deg", "176" }, { "plusmn", "177" },
    ...
    static final String[][]         HTML40_ARRAY    = { { "fnof", "402" }, { "Alpha", "913" }, { "Beta", "914" },
                            ...
                            if (entityContent.charAt(0) == '#') {
                                if (entityContentLen > 1) {
                                    ...
                                    try {
                                        ...
                                        if (entityValue > 65535) entityValue = -1;
                                    } catch (NumberFormatException e) {
                                        entityValue = -1;
                                    }
                                }
                            } else entityValue = entityValue(entityContent);
