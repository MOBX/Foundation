...
public class RandomUtils {
    ...
    public static String randomMACAddr() {
        return String.format("%02x:%02x:%02x:%02x:%02x:%02x", RandomUtils.nextInt(255), RandomUtils.nextInt(255),
    ...
    public static String randomIPAddr() {
        return String.format("%d.%d.%d.%d", RandomUtils.nextInt(230), RandomUtils.nextInt(255),
