...
public class ArrayUtils {
    ...
    public static boolean[] remove(boolean[] array, int index) {
        return (boolean[]) removeIndex(array, index);
    }
    ...
    public static byte[] remove(byte[] array, int index) {
        return (byte[]) removeIndex(array, index);
    }
    ...
    public static char[] remove(char[] array, int index) {
        return (char[]) removeIndex(array, index);
    }
    ...
    public static double[] remove(double[] array, int index) {
        return (double[]) removeIndex(array, index);
    }
    ...
    public static float[] remove(float[] array, int index) {
        return (float[]) removeIndex(array, index);
    }
    ...
    public static int[] remove(int[] array, int index) {
        return (int[]) removeIndex(array, index);
    }
    ...
    public static long[] remove(long[] array, int index) {
        return (long[]) removeIndex(array, index);
    }
    ...
    public static short[] remove(short[] array, int index) {
        return (short[]) removeIndex(array, index);
    }
    ...
    public static <E> TreeSet<E> toTreeSet(E[] array) {
    ...
    public static <E> TreeSet<E> toTreeSet(E[] array, Comparator<? super E> comparator) {
        TreeSet<E> list = new TreeSet<E>(comparator);
        for (E o : array) {
            list.add(o);
        }
        return list;
    ...
    public static <E> E[] sort(E[] array, Comparator<? super E> comparator) {
        ...
        TreeSet<E> set = toTreeSet(array, comparator);
        int i = 0;
        for (E e : set) {
            result[i++] = e;
        }
    ...
    public static <T> T[] toArray(Collection<T> c, T[] array) {
        int size = c.size();
    ...
    public static <T> T[] toArray(Collection<T> c, Class<T> type) {
        T[] array = newArray(type, c.size());
        fillArray(c, array);
        return array;
    }

    static <T> T[] fillArray(Iterable<T> elements, T[] array) {
        int i = 0;
