...
public class Asserts {
    ...
    public static void equalsAssert(String message, Object expected, Object actual) {
        ...
        if ((expected != null) && (isEquals(expected, actual))) return;
...

    {
        ...
        if (expecteds == null) fail(header + "expected array was null");
        if (actuals == null) fail(header + "actual array was null");
    ...
    public static void equalsAssert(String message, double expected, double actual, double delta) {
        ...
        if (Math.abs(expected - actual) > delta) failNotEquals(message, new Double(expected), new Double(actual));
    }
