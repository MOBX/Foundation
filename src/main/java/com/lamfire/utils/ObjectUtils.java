...
public class ObjectUtils {
    ...
    public static void setPropertiesValues(Object instance, Map<String, Object> propertyValues) {
        if (instance == null || propertyValues == null || propertyValues.isEmpty()) return;
        try {
    ...
    public static Object invokeMethod(Object obj, Method invokeMethod, Object... args) {
        ...
        try {
            ...
            throw new RuntimeException("cannot invoke " + invokeMethod.getName() + " for " + obj.getClass().getName(),
                                       e);
        } finally {
            if (hasChangeAccessibleFlag) {
    ...
    public static Method getMethod(Object obj, String name, Object[] args) throws SecurityException,
