...
public class ByteBufferUtils {
    ...
    public static byte[] getArray(ByteBuffer buffer) {
        ...
        if (buffer.hasArray()) {
            ...
            else return Arrays.copyOfRange(buffer.array(), start + buffer.arrayOffset(),
     ...
     * @return the last index (i.e. BB position) of the value within the array [between buffer.position() and
     * buffer.limit()]; <code>-1</code> if not found.
     */
    ...
    public static ByteBuffer clone(ByteBuffer o) {
        ...
        if (o.remaining() == 0) return EMPTY_BYTE_BUFFER;
