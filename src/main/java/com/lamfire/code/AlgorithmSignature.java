...
public class AlgorithmSignature {
    ...
    public static byte[] signSHA1WithDSA(PrivateKey privateKey, byte[] data) throws SignatureException,
                                                                            InvalidKeyException,
    ...
    public static boolean verifySHA1WithDSA(PublicKey pubkey, byte[] data, byte[] signature) throws SignatureException,
                                                                                            InvalidKeyException,
                                                                                            NoSuchAlgorithmException {
